        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(child: Image.asset("assets/images/ic_login_green.png")
              ...
              Center(
                child: Text(
                  'أهلا بك في تطبيق التواصل الجامعي',
                  style: TextStyle(
                  ...
                  child: Center(
                    child: Column(children: [
                      ...
                      MaterialButton(
                          ...
                          minWidth: 250,
                          color: Color.fromARGB(255, 51, 156, 45),
                          onPressed: () async {
                            if (await service_provider.checkInternet()) {
                              await main_provider.login(phoneController.text,
